...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>High</td>
      <td>Functional</td>
      <td><strong>FAIL</strong> — No <code>add_score()</code> method.</td>
      <td>#13</td>
    </tr>
    <tr>
      <td>TC-002</td>
      ...
      <td>Raises <code>ValueError</code>, scores unchanged.</td>
      <td>High</td>
      <td>Negative</td>
      <td><strong>FAIL</strong> — No <code>add_score()</code> method.</td>
      <td>#13</td>
    ...
    <tr>
      ...
      <td>REQ-2</td>
      <td>Student has <code>[80, 90, 100]</code></td>
      ...
      <td>High</td>
      <td>Functional</td>
      <td><strong>PASS</strong> — Returned <code>90</code>.</td>
      <td>—</td>
    </tr>
    <tr>
      <td>TC-005</td>
    ...
    <tr>
      ...
      <td>REQ-3</td>
      <td>Roll <code>101</code> exists</td>
      <td>Add <code>Student("Ali", 101)</code>, then add <code>Student("Ahmed", 101)</code>.</td>
      <td>Raises <code>ValueError</code> for duplicates.</td>
      <td>High</td>
      <td>Negative</td>
      <td><strong>PASS</strong> — Raised <code>ValueError</code>.</td>
      <td>—</td>
    </tr>
    <tr>
      <td>TC-008</td>
      ...
      <td>REQ-4</td>
      <td>Student <code>"Ali"</code> exists</td>
      <td>Add <code>Student("Ali", 101)</code> and search using <code>"ali"</code>.</td>
      <td>Finds and returns student record.</td>
      <td>Low</td>
      <td>Functional</td>
      <td><strong>FAIL</strong> — No <code>find_student()</code> method.</td>
      <td>#14</td>
    </tr>
    <tr>
      <td>TC-009</td>
      ...
      <td>Score <code>100</code> accepted successfully.</td>
      <td>Medium</td>
      <td>Boundary</td>
      <td><strong>FAIL</strong> — No <code>add_score()</code> method.</td>
      <td>#13</td>
    ...
    <tr>
      ...
      <td>Score <code>0</code> accepted successfully.</td>
      <td>Medium</td>
      <td>Boundary</td>
      <td><strong>FAIL</strong> — No <code>add_score()</code> method.</td>
      <td>#13</td>
    ...
    <tr>
      ...
      <td>REQ-6</td>
      <td>Average is <code>82.0</code></td>
      <td>Set <code>student.scores = [82]</code> and call <code>student.get_grade()</code>.</td>
      <td>Returns grade letter <code>'B'</code>.</td>
      <td>Low</td>
      <td>Functional</td>
      <td><strong>FAIL</strong> — No <code>get_grade()</code> method.</td>
      <td>#15</td>
    </tr>
    <tr>
      <td>TC-012</td>
      <td>Grade letter at boundary</td>
      <td>REQ-6</td>
      <td>Average is <code>90.0</code></td>
